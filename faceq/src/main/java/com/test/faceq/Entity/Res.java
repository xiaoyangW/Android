...
public class Res {
        ...
        //getRes(isBoy, imageType) 得到指定性别、指定图片类型的资源数组
        //getRealRes(isBoy, imageType, position) 得到指定性别、指定图片类型、指定索引位置的真实图片资源
        //getBoyDefault            得到默认的男生形象
        //getGirlDefault           得到默认的女生形象

        /**
         * 性别    true=帅哥   false=美女
         */
        public static final String EXTRA_ISBOY ="isBoy";

        /**
         * 图片类型
         *  0:发型    getBoyHair/getRealBoyHair/getGirlHair/getRealGirlHair
         *  1:脸型    getFaceShape
         *  2:眉毛    getEyeBrow
         *  3:眼睛    getEye
         *  4:嘴巴    getMouth
         *  5:特征    getBoyFeature/getRealBoyFeature/getGirlFeature/getRealGirlFeature
         *  6:眼镜    getGlass
         *  7:衣服    getBoyClothes/getGirlClothes
         *  8:帽子    getHat
         *  9:爱好    getHobby
         * 10:背景    getBackGround
         * 11:气泡    getPop
         */
        public static final String EXTRA_TYEP ="image_type";
        ...
        static Integer[] boyHair;
        static Integer[] realBoyHair;
        static Integer[] girlHair;
        static Integer[] realGirlHair;
        static Integer[] faceShape;
        static Integer[] eyebrow;
        static Integer[] eye;
        static Integer[] mouth;
        static Integer[] feature;
        static Integer[] feature_g;
        static Integer[] realBoyFeature;
        static Integer[] realGirlFeature;
        static Integer[] glass;
        static Integer[] boy_clothes;
        static Integer[] girl_clothes;
        static Integer[] hat;
        static Integer[] hobby;
        static Integer[] background;
        static Integer[] pop;
        static Integer[] boy_default;
        static Integer[] girl_default;

        /**
         * 得到指定性别、指定图片类型的资源数组
         */
        public static Integer[] getRes(boolean isBoy, int imageType){
            Integer[] res = null;
            switch (imageType) {
                case 0:
                    if (isBoy) {
        ...
        /**
         * 得到指定性别、指定图片类型、指定索引位置的真实图片资源
         */
        public static Integer getRealRes(boolean isBoy, int imageType, int position){
            int b_res;
            if(imageType == 0){         //头发的预览图和真实图不同
                if(isBoy){              //头发分男女
                    b_res = getRealBoyHair()[position];
                }else{
                    b_res = getRealGirlHair()[position];
                }
            }else if(imageType == 5){   //特征的预览图和真实图不同
                if(isBoy){              //特征分男女
                    b_res = getRealBoyFeature()[position];
                }else{
                    b_res = getRealGirlFeature()[position];
                }
            }else{                      //其它部位预览图和真实同相同
                b_res = getRes(isBoy, imageType)[position];
            }
            //空图像的预览图和真实图不同
         ...
         * 获取boy发型的图片地址数组
         */
        private static Integer[] getBoyHair(){
            if(boyHair==null){
                boyHair = new Integer[]{
                        R.drawable.pic_s1_0,
                        R.drawable.pic_s1_1,
         ...
         * 获取真实发型的图片数组
         */
        private static Integer[] getRealBoyHair(){
            if(realBoyHair == null){
                realBoyHair = new Integer[]{
         ...
         * 获取girl发型的图片地址数组
         */
        private static Integer[] getGirlHair(){
            if(girlHair==null){
                girlHair = new Integer[]{
         ...
         * 获取真实girl的图片数组
         */
        private static Integer[] getRealGirlHair(){
            if(realGirlHair == null){
                realGirlHair = new Integer[]{
         ...
         * 脸型图片数组
         */
        private static Integer[] getFaceShape(){
            if(faceShape == null){
                faceShape = new Integer[]{
         ...
         * 眉毛图片数组
         */
        private static Integer[] getEyeBrow(){
            if(eyebrow == null){
                eyebrow = new Integer[]{
                        R.drawable.	pic_s3_1,
                        R.drawable.	pic_s3_2,
         ...
         * 嘴巴图片数组
         */
        private static Integer[] getMouth(){
            if(mouth == null){
                mouth = new Integer[]{
                        R.drawable.pic_s5_1,
                        R.drawable.pic_s5_2,
         ...
         * 获取boy特征图片数组
         */
        private static Integer[] getBoyFeature(){
            if(feature == null){
                feature = new Integer[]{
                        R.drawable.show_no,
                        R.drawable.pic_s6_1,
         ...
         * 获取真实boy特征图片数组
         */
        private static Integer[] getRealBoyFeature(){
            if(realBoyFeature == null){
                realBoyFeature = new Integer[]{
         ...
         * 获取girl特征图片数组
         */
        private static Integer[] getGirlFeature(){
            if(feature_g == null){
                feature_g = new Integer[]{
                        R.drawable.show_no,
                        R.drawable.pic_s6_1,
                        R.drawable.pic_s6_10,
                        R.drawable.pic_s6_11,
         ...
         * 获取真实girl特征图片数组
         */
        private static Integer[] getRealGirlFeature(){
            if(realGirlFeature == null){
                realGirlFeature = new Integer[]{
                        R.drawable.show_nothing,
                        R.drawable.pic_rs6_1,
                        R.drawable.pic_rs6_10,
                        R.drawable.pic_rs6_11,
         ...
         * 眼镜图片数组
         */
        private static Integer[] getGlass(){
            if(glass == null){
                glass = new Integer[]{
                        R.drawable.show_no,
                        R.drawable.pic_s7_1,
         ...
         * 获取boy衣服图片数组
         */
        private static Integer[] getBoyClothes(){
            if(boy_clothes == null){
                boy_clothes = new Integer[]{
                        R.drawable.pic_s8_1,
                        R.drawable.pic_s8_2,
                        R.drawable.pic_s8_3,
                        R.drawable.pic_s8_4,
         ...
         * 获取girl衣服图片数组
         */
        private static Integer[] getGirlClothes(){
            if(girl_clothes == null){
                girl_clothes = new Integer[]{
         ...
         * 获取爱好图片数组
         */
        private static Integer[] getHobby(){
            if(hobby == null){
                hobby = new Integer[]{
                        R.drawable.show_no,
         ...
         * 获取背景图片数组
         */
        private static Integer[] getBackGround(){
            if(background == null){
                background = new Integer[]{
         ...
         * 获取默认boy图片数组
         */
        public static Integer[] getBoyDefault(){
            if(boy_default == null){
                boy_default = new Integer[]{
         ...
         * 获取默认girl图片数组
         */
        public static Integer[] getGirlDefault(){
            if(girl_default == null){
                girl_default = new Integer[]{
                        R.drawable.pic_rs1_g_4,
                        R.drawable.pic_s2_20006,
                        R.drawable.pic_s3_1,
                        R.drawable.pic_s4_34,
